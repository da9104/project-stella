            ...
            {messages.map((message, index) => (
              <div key={message.id} className="w-full">
               {message.role === "user" ? (
                ...
                {/* Heroicons */}
                <div className="bg-gray-500 h-10 w-10 rounded-lg flex justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 self-center text-white">
                ...
                <div className="rounded-lg p-3 w-full border-gray-400 border-2 text-sm">
                {message.content}
                </div>
                </div>
               ) : (
                <div className="flex items-center gap-x-2"> 
                   {/* Heroicons */}
                   <div className="bg-orange-500 h-10 w-10 rounded-lg flex justify-center">
                   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 self-center text-white">
                  ...
                  <div className="rounded-lg p-3 w-full border-orange-400 border-2 text-sm">
                    {message.content}
                  </div>
                </div>
              )}
